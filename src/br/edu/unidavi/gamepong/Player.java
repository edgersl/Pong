...
class Player implements GameStateController {
   ...
   boolean usarUmaUnicaVez = true;
    ...
    public void step(long l) {
        ...
        //Setando maldita pontuação corretamente
        if(r.humor.getPontuacaoa() != null){
            usarUmaUnicaVez = false;
            pontuacaoA = r.humor.ponta;
            pontuacaoB = r.humor.pontb;
         ...
         */
        posBarra1 = r.humor.barraInteira02;
        ...
        if(r.humor.getBola01x() != null){
            posBolaX = r.humor.bolaInteira01x;
            posBolaY = r.humor.bolaInteira01y;
        }  
    ...
    public void draw(Graphics graphic){
        ...
        graphic.drawString("Edgar", largura / 2 - 90, 55);
        graphic.drawString("Oponente", largura / 2 + 10, 55);
        ...
        saida.println("bola02;"+posBolaX+";"+posBolaY);
