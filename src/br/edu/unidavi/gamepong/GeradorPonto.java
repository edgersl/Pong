...
public class GeradorPonto {
    ...
    private String pontuacaoa,pontuacaob;
    int ponta,pontb;
            
    public String getPontuacaoa() {
        return pontuacaoa;
    }

    public void setPontuacaoa(String pontuacaoa) {
        this.pontuacaoa = pontuacaoa;
        ponta =  Integer.parseInt(pontuacaoa);
    }



    public String getPontuacaob() {
        return pontuacaob;
    }

    public void setPontuacaob(String pontuacaob) {
        this.pontuacaob = pontuacaob;
        pontb =  Integer.parseInt(pontuacaob);
    }
